...
colnames( CovidMoscowDB) <- c("date", "newCases", "TotalCases", "weekday")
...
if( dim(CovidMoscowDB.1)[1] > dim(CovidMoscowDB)[1]) {
  write.xlsx(CovidMoscowDB.1, file="data/CovidMoscow.xlsx")
...
plot_npsi_fit <- function( npsi, seg,  CovidMoscow )  { 
  ...
  CovidMoscow[ ,BLfit := BL_moscow$fit ]
  CovidMoscow[ ,BLse :=  BL_moscow$se ]
